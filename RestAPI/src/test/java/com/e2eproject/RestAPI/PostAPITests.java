package com.e2eproject.RestAPI;
...
public class PostAPITests extends TestBase {
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		Usersdata users = new Usersdata("morpheus", "leader"); //expected users obejct
		...
		//json to java object:
		Usersdata usersResObj = mapper.readValue(responseString, Usersdata.class); //actual users object
